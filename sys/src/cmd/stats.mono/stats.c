...
{
	/* Peach */
	mkcol(0, 0xDDDDDDDD, 0xDDDDDDDD, 0xDDDDDDDD);
	/* Aqua */
	mkcol(1, 0xDDDDDDDD, 0xDDDDDDDD, 0xDDDDDDDD);
	/* Yellow */
	mkcol(2, 0xDDDDDDDD, 0xDDDDDDDD, 0xDDDDDDDD);
	/* Green */
	mkcol(3, 0xDDDDDDDD, 0xDDDDDDDD, 0xDDDDDDDD);
	/* Blue */
	mkcol(4, 0xDDDDDDDD, 0xDDDDDDDD, 0xDDDDDDDD);
	/* Grey */
	cols[5][0] = allocimage(display, Rect(0,0,1,1), CMAP8, 1, 0x222222FF);
	cols[5][1] = allocimage(display, Rect(0,0,1,1), CMAP8, 1, 0x222222FF);
	cols[5][2] = allocimage(display, Rect(0,0,1,1), CMAP8, 1, 0x111111FF);
}
